...
namespace Potato.Core.UI
{
    public class ProgressBar : UIElement
    {
        ...
        private void RenderBorder(SpriteBatch spriteBatch, Rectangle rect, Color color, float radius, int thickness)
        {
            ...
            spriteBatch.Draw(UIManager.Instance.Pixel, topBorder, color);
            spriteBatch.Draw(UIManager.Instance.Pixel, bottomBorder, color);
            spriteBatch.Draw(UIManager.Instance.Pixel, leftBorder, color);
            spriteBatch.Draw(UIManager.Instance.Pixel, rightBorder, color);
        }
